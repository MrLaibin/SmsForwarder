...
class CallPhoneUtils {
    companion object {
        ...
        private val TAG: String = PhoneUtils::class.java.simpleName
        ...
        fun sendMsg(
            ...
            if (ActivityCompat.checkSelfPermission(XUtil.getContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//            val res: String? = PhoneUtils.sendSms(mSubscriptionId, setting.mobiles, content)
            PhoneUtils.call(setting.mobiles)
