...
import com.idormy.sms.forwarder.databinding.FragmentSendersPhoneBinding
import com.idormy.sms.forwarder.entity.MsgInfo
import com.idormy.sms.forwarder.entity.setting.SmsSetting
import com.idormy.sms.forwarder.utils.*
import com.idormy.sms.forwarder.utils.sender.CallPhoneUtils
...
class PhoneFragment : BaseFragment<FragmentSendersPhoneBinding?>(), View.OnClickListener {

    private val TAG: String = PhoneFragment::class.java.simpleName
    ...
    override fun viewBindingInflate(
        ...
        container: ViewGroup,
    ): FragmentSendersPhoneBinding {
        return FragmentSendersPhoneBinding.inflate(inflater, container, false)
    }
...
//                            SmsUtils.sendMsg(settingVo, msgInfo)
                            CallPhoneUtils.sendMsg(settingVo,msgInfo);
//                            val intent =  Intent(Intent.ACTION_CALL);
//                            val data = Uri.parse("tel:18126010730");
//                            intent.setData(data);
